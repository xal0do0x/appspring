...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "appspring@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "appspring API";

        private String description = "appspring API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "appspring";
